...
public class Day18SolverPart2 {
	...
	static class Maze {
		...
		int getTotalCollectionDistance() {
			...
			RobotState finalState = (RobotState) StatePathfinder.findClosestGoalState(initialState);
	...
	interface State<T extends State> extends Comparable<State> {
		boolean isDone();
	...
	static class StatePathfinder<T extends State> {
